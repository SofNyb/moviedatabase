// src/pages/Name/FindCoplayers.jsx
...
export default function FindCoplayers() {
  ...
  useEffect(() => {
    ...
    // Fetch the original name and coplayers
    Promise.all([
      nameService.getNameById(nconst),
      nameService.findCoplayers(nconst, 10)
    ])
      .then(async ([nameData, coplayersData]) => {
        setOriginalName(nameData.primaryName || nameData.name || "Unknown");
        
        // Fetch full details for each coplayer
